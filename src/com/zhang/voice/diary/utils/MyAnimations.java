package com.zhang.voice.diary.utils;
...
public class MyAnimations{
	...
	public static void initOffset(Context context){
		...
		yOffset		= 0;// -(int) (8.667 *context.getResources().getDisplayMetrics().density);
	}
	...
	public static void startAnimationsIn(ViewGroup viewgroup,int durationMillis) {
		for (int i = 0; i < viewgroup.getChildCount(); i++) {
				ImageButton inoutimagebutton = (ImageButton) viewgroup
						.getChildAt(i);
				inoutimagebutton.setVisibility(0);inoutimagebutton.setFocusable(true);inoutimagebutton.setClickable(true);
				MarginLayoutParams mlp = (MarginLayoutParams) inoutimagebutton.getLayoutParams();
				Animation animation = new TranslateAnimation(Animation.ABSOLUTE,mlp.rightMargin-xOffset,Animation.RELATIVE_TO_SELF,0F,
															 Animation.ABSOLUTE,yOffset + mlp.bottomMargin,Animation.RELATIVE_TO_SELF, 0F);
	...
	public static void startAnimationsOut(ViewGroup viewgroup,int durationMillis) {
		for (int i = 0; i < viewgroup.getChildCount(); i++) {
				...
				animation.setStartOffset(((viewgroup.getChildCount()-i) * 100)
						/ (-1 + viewgroup.getChildCount()));//顺序倒一下比较舒
				...
				animation.setAnimationListener(new Animation.AnimationListener() {
					...
					public void onAnimationEnd(Animation arg0) {
						...
						inoutimagebutton.setFocusable(false);inoutimagebutton.setClickable(false);
					}
				});
				inoutimagebutton.startAnimation(animation);
			}
